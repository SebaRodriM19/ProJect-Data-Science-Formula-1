...
subtitle: 'ATTENZIONE: i dati utilizzati non comprendono la stagione 2020'
...
***Questo conferma che le scuderie hanno contribuito in modo determinante al numero di vittorie dei piloti e viceversa. Confermo inoltre che, come ipotizzato inizialmente, a seconda dell'epoca e del motore utilizzato, c'è una scuderia diversa che si distingue rispetto alle altre. Infine, si può affermare che Lewis Hamilton, essendo un pilota vincente e correndo attualmente per la Mercedes, possa superare il record di vittorie di Michael Schumacher nella prossima stagione della Formula 1, diventando il pilota più vincente nella storia.***